...
func _on_rig_heavy_attack() -> void:
	area_attack.deal_damage(damage, crit_rate)
	navigation_agent_3d.avoidance_mask = 1
	
func orient_rig(target_position: Vector3) -> void:
	target_position.y = rig.global_position.y # Ensures that the rig is at ground level to prevent unintended tilting of the rig.
